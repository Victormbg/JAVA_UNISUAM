...
public class PrincipalView extends JFrame {
	...
	public void LoadTableEmp() {
		...
		tbl_emp.setModel(modelo);
		 ...
		 for(int i=0;i<ListaEmp.size();i++){
	            Object linha[] = new Object[]{ListaEmp.get(i).getNome(),
	            							  ListaEmp.get(i).getCnpj()};
	            modelo.addRow(linha);
	        }
	}
	...
	public PrincipalView() {
		...
		tbl_emp.setBorder(new BevelBorder(BevelBorder.LOWERED, Color.BLACK, Color.DARK_GRAY, Color.BLACK, Color.DARK_GRAY));
		...
		panel_3.setBorder(new TitledBorder(new BevelBorder(BevelBorder.LOWERED, new Color(64, 64, 64), new Color(192, 192, 192), new Color(128, 128, 128), new Color(128, 128, 128)), "Empresa", TitledBorder.LEFT, TitledBorder.TOP, null, Color.WHITE));
		...
		lblNewLabel_6.setIcon(new ImageIcon("..\\ApsPOO\\img\\oi.jpg"));
